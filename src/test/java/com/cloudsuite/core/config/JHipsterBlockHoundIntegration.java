package com.cloudsuite.core.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.cloudsuite.core.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.cloudsuite.core.security.DomainUserDetailsService", "createSpringSecurityUser");
